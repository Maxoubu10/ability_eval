...
JSON_INPUT_FILE_PATH = r'level3/data/input.json'
...
class Rental:
    ...
    def get_rental_price_info(self, car: Car):
        rental_info = {
            ...
            "commission": self.get_commission_data(car)
        }
    ...
    def get_commission_data(
        ...
        commission_data = {
            ...
            "assistance_fee": int(roadside_assistance_fee),
...
if __name__ == '__main__':
    ...
    with open(r'level3/data/generated_output.json', 'w') as output_file:
